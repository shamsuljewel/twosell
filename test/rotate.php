...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../jqplot/examples/examples.min.css" />
...
<!-- Additional plugins go here -->
  ...
  <script class="include" language="javascript" type="text/javascript" src="../jqplot/plugins/jqplot.dateAxisRenderer.min.js"></script>
  <script class="include" language="javascript" type="text/javascript" src="../jqplot/lugins/jqplot.canvasTextRenderer.min.js"></script>
  <script class="include" language="javascript" type="text/javascript" src="../jqplot/plugins/jqplot.canvasAxisTickRenderer.min.js"></script>
