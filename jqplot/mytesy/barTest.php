<?php 
   include '../../admin_config.php';
    //$h = $_SESSION['js-host']."/jqplot/";
//    $l = "//localhost/twosell/jqplot/";
   $l = $_SESSION['js-host']."/jqplot";
?>
<!DOCTYPE html>
...
<!-- End additional plugins -->
	...
	<script type="text/javascript" src="<?php echo $l; ?>/mytesy/example.min.js"></script>
