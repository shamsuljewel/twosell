...
class Utility {
    ...
    public function itemCollector($string, $itemNames) {
     ...
     public function onTaging($string, $brandNames, $colorNames, $attributes, $productId) {
        $databaseUtility = new DatabaseUtility();
        $flagItem = true;
        $flagAtt = true;
        $termTag = array();
        //$termTag['item'] = key_exists($productId, $tsl_product_groupSynonym) ? $tsl_product_groupSynonym[$productId] : '';
