...
?>
<form name="pos-product" id="pos-product" action="suggestion.php" method="post">
<div id="content">
    ...
    <div id="bottom_right"><input type="submit" name="submit_products" id="submit_products" value="PAY" /></div>
</form>