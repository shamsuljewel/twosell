...
?>
  <div id="admin_home">
    <div id="left_in">
	<div id="form_id">
        <p class="bold bigsize">Add New Admin Information</p>
...
//                                    $group_lists = $groups->getGroupList();
                                    echo "<select name='admin_type' id='admin_type'>";
                    ...
                    <li>
                            ...
                            <input type="text" name="userName" id="userName" onFocus="userName.value=''" />
                    </li>
                    <li>
                            <label>Password *</label>
                            <input type="password" name="password" id="password" onFocus="password.value=''" />
...
//                                    print_r($result);
                                    for($i=0; $i < count($result); $i++){
                                        ...
                                        echo "<input type='checkbox' name='storebox' value='$store_internalid'>$store_internalid";
                                    }
                                }
                                else{
                                    //echo $result;
                    ...
                    <tr><td align="center"><input type="button" name="addAdmin" id="addAdmin" value="Add Admin" class="submit_btn"  /></td><td></td></tr>
                    </table>
                </fieldset>
            </form>
        </div>
